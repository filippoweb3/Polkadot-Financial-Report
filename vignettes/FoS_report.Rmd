...
Specific to the Web3 Foundation, the maximum APY under Phase II is achieved with 100000 DOT in self-stake across all nominated nodes sent to the active set, assuming all nominated nodes are run in-house.
